...
public class OnlineController {
    ...
    public void playRoundAI(){
        ...
        // this is handled within the game model
    ...
    public Map getHumanCard() {
        Player hPlayer = null;
        for (int i = 0; i < this.game.getPlayer().size(); i++) {
            if (this.game.getPlayer().get(i).getPlayerID() == 0) {
                hPlayer = this.game.getPlayer().get(i);
            }
        }
    ...
    public Map getAi1TopCard() {
        ...
        for (int i = 0; i < this.game.getPlayer().size(); i++) {
            if (this.game.getPlayer().get(i).getPlayerID() == 1) {
                Ai1 = this.game.getPlayer().get(i);
            }
        }

        this.game.getPlayer().get(1);
    ...
    public Map getAi2TopCard() {
        ...
        for (int i = 0; i < this.game.getPlayer().size(); i++) {
            if (this.game.getPlayer().get(i).getPlayerID() == 2) {
                Ai2 = this.game.getPlayer().get(i);
            }
        }
    ...
    public Map getAi3TopCard() {
        ...
        for (int i = 0; i < this.game.getPlayer().size(); i++) {
            if (this.game.getPlayer().get(i).getPlayerID() == 3) {
                Ai3 = this.game.getPlayer().get(i);
            }
        }
    ...
    public Map getAi4TopCard() {
        ...
        for (int i = 0; i < this.game.getPlayer().size(); i++) {
            if (this.game.getPlayer().get(i).getPlayerID() == 4) {
                Ai4 = this.game.getPlayer().get(i);
            }
        }

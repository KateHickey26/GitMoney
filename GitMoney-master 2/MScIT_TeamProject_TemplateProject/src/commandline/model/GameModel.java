...
public class GameModel {
	...
	// this method is not used anywhere, and not needed?
	// getting all players top cards and moving them to main deck
	...
	public void transferCards(int resultInt) {
		...
		if (resultInt == -2) {
			...
			activePlayer = resultInt; //sets active player to number of index winner
	...
	public void transferToCommunal(Deck cards) {
		...
		//System.out.println("To communal deck of size: "+communalDeck.sizeOfDeck());
	...
	// checks if a player has won (is last player in player array)
